...
class NeuManReader():
    ...
    @classmethod
    def read_scene(cls,scene_dir, cfg, tgt_size=None, normalize=False, bkg_range_scale=1.1, human_range_scale=1.1, mask_dir='segmentations', smpl_type='romp', keypoints_dir='keypoints', densepose_dir='densepose'):
        ...
        captures, point_cloud, num_views, num_cams = cls.read_captures(cfg, scene_dir, tgt_size, mask_dir=mask_dir, keypoints_dir=keypoints_dir, densepose_dir=densepose_dir, if_refine = False)
    ...
    @classmethod
    def read_captures(cls, cfg, scene_dir, tgt_size, mask_dir='segmentations', keypoints_dir='keypoints', densepose_dir='densepose', if_refine = False):
        caps = []
